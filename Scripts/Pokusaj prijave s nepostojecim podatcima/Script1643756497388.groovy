...
WebUI.setText(findTestObject('Object Repository/Page_Rezijiser/input_Rezijiser_mat-input-0'), 'testing.test@testing.co')
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Rezijiser/span_Greka prilikom prijave'))
